...
class FourthCell: UITableViewCell {
    ...
    override func awakeFromNib() {
        ...
        collectionView.register(UINib(nibName: "FourthColCell", bundle: nil), forCellWithReuseIdentifier: "FourthColCell")
    }
...
extension FourthCell: UICollectionViewDelegate, UICollectionViewDataSource,UICollectionViewDelegateFlowLayout{
    ...
    func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        guard let cell = collectionView.dequeueReusableCell(withReuseIdentifier: "FourthColCell", for: indexPath as IndexPath) as? FourthColCell,
    ...
    func collectionView(_ collectionView: UICollectionView, layout collectionViewLayout: UICollectionViewLayout, sizeForItemAt indexPath: IndexPath) -> CGSize {
        ...
        let height: CGFloat = 210 // collectionViewCell 높이
